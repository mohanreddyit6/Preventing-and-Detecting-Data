                    ...
                    <div class="col-md-12">
                       ...
                       <div class="col-md-10" style="margin-left: -200px">
                            <div id='topnav'>
                                <ul class="top-menu">
                                    <li class='has-sub'>
                                        <a href='ahome.jsp'><span>Home</span></a>
                                    </li>
                                    <li class='has-sub'>
                                        <a href='udetail.jsp'><span>User Details</span></a>
                                    </li>
                                    <li class='has-sub active'>
                                        <a href="viewfile.jsp"><span>View File</span></a>
                                    </li>
                                    <li class="has-sub">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;">Sent File Details</h3>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
                    ...
                    <!--<div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">-->
                        ...
                        <table border="1" style="text-align: center;margin-left: 220px">
                            <tr>
                                ...
                                <!--<th style="text-align: center;width: 100px;">File</th>-->
<!--                                <th style="text-align: center;width: 100px;">Date of Birth</th>
                                <th style="text-align: center">Send File</th>
...
<!--                                        <td></td>     
                                        <td></td>     
                        <td> <a href="sendfile.jsp?"><font style="color: green">Send</a></font> </td>
                        <td> <a href="mail.jsp?"><font style="color: red">Send key</a></font> </td> -->
                                        <tr />
                                        <%} 
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
