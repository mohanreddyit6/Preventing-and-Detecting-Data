                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("SELECT * FROM upload WHERE name ='" + name + "' AND showfile='Yes'");
                                        while(rs.next())
...
<!--                                        <td></td>     
                                        <td></td>     
-->                        <td> <a href="lockpass.jsp?"><font style="color: green">lock</a></font> </td>
                        <!--<td> <a href="mail.jsp?"><font style="color: red">unlock</a></font> </td>--> 
                         <td> <a href="dvc.jsp?"><font style="color: red">Download</a></font> </td> 
                                        <tr />
                                        <%} 
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
