...
<!--                                    <li class='has-sub'>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;">Finger Print </h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <center><div class="container" style="">
                <div class="row" style="width: 500px"><br>
                    <div class="col-md-8">
                        <form class="contact-form" action="upload.jsp" method="post" enctype="multipart/form-data">
                            <label style="font-size: 20px"></label><input type="file"  name="upload" style="margin-left: 35px;"/><br /><br /></font>
