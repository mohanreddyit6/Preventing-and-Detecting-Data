        ...
        <div class="body">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;"> Registration</h3>
                        </div>
                    </div>
                </div>
            </div>
            <!--<div style="background-image: url('images/ree.jpg');height: 600px;margin-top: -20px">-->
            <div class="col-md-6">
                <center><h3>   </h3></center>
            </div>
            ...
            <center><div class="container" style="">
                <div class="row" style="width: 500px"><br>
                    <div class="col-md-8">
                        <form class="contact-form" action="loginaction.jsp" method="get" enctype="multipart/form-data">
                            ...
                            <input type="text" class="form-control" name="loc" placeholder="Your Location"/>
