                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-10" style="margin-left: -200px">
                            <div id='topnav'>
                                <ul class="top-menu">
                                    <li class='has-sub'>
                                        <a href='udetail.jsp'><span>Home</span></a>
                                    </li>
<!--                                    <li class='has-sub'>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;">File Upload to User</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <center><div class="container" style="">
                <div class="row" style="width: 500px"><br>
                    <div class="col-md-8">
                        <form class="contact-form" action="uploadServlete" method="post" enctype="multipart/form-data">
                                <select id="keys" name="name" class="form-control" style="width: 220px; height: 30px;" > 
                                    ...
                                    <p style="color: white;font-family:fantasy;font-size:130%;margin-left: 48px;"><input type ="text" class="form-control" name ="sub" size="30"/></p>	
                          
                            <label style="font-size: 20px"></label><input type="file"  name="file" style="margin-left: 25px;"/><br /><br /></font>
