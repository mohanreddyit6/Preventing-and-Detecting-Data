...
<!--                                    <li class='has-sub'>
                                        <a href='uviewfile.jsp'><span>View File</span></a>
                                    </li>
                                    <li class='has-sub active '>
                                        <a href="unlockpass.jsp"><span>Lock Files</span></a>
                                    </li>
                                    <li class="has-sub">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;">Unlock Secret Password</h3>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
            </div>
            <!--<div style="background-image: url('images/devlog2.jpg');height: 350px;margin-top: -80px">-->
            <div class="col-md-6">
...
<!--                            <label style="color: white">User Name</label>-->
                            ...
                            <input type="submit" value="" style="background-image: url('images/button.png');width: 110px;height: 42px">                        </form>
                    </div>
                    <!-- Sidebar -->
                </div>
            </div></center>
