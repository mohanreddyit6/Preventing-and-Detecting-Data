...
<!--[if gt IE 9]><!-->	
    ...
    <body>
        <%
           if (request.getParameter("sec") != "Success") {
        ...
        <div class="body">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;">Admin Home</h3>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
            ...
            <br><br><br><center><IMG SRC="images/ahome.jpg" ALT="some text" WIDTH=800 HEIGHT=400></center>
            <div class="col-md-6">
