...
<!--                                    <li class='has-sub'>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;">File Lock</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <center><div class="container" style="">
                <div class="row" style="width: 500px"><br>
                    <div class="col-md-8">
                        <form class="contact-form" action="lockupdate.jsp" method="get" enctype="multipart/form-data">
                                <select id="keys" name="file" class="form-control" style="width: 220px; height: 30px;" > 
                                        ...
                                        String  Name=(String)session.getAttribute("Name");
                                            String sql1 = "select * from upload where name= '" + Name + "' AND showfile='Yes' ";
