...
//                        session.setAttribute("n3", sname1);
                      String  name =(String)session.getAttribute("Name");
                        ...
                        ResultSet rs = st.executeQuery("select * from reg where size='" + size + "' AND name= '" + name + "'");
                   ...
                   while (rs.next()) {
                    ...
                    <a href="search.jsp?<%=rs.getInt("id")%>" style="margin-top: 10px">
                        <img src="view1.jsp?id=<%=rs.getInt("id")%>" alt="" width="120" height="99" ></img></a>
                    
                    
                    <%
                            
                        }
                                               }response.sendRedirect("fdown.jsp?msg=seccsss");
                    %>
