                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;">User Details</h3>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
            ...
            <div class="row">
                <div class="box" style="height: 400px;">
                    ...
                    <!--<div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">-->
                        ...
                        <td> <a href="sendfile.jsp?<%=rs.getString("name")%>"><font style="color: green">Send</a></font> </td>
                        <td> <a href="mail.jsp?<%=rs.getString("id")%>"><font style="color: red">Send key</a></font> </td></tr> 
