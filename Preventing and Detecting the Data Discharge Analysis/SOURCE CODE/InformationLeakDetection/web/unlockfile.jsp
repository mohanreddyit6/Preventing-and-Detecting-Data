                       ...
                       <div class="col-md-10" style="margin-left: -200px">
                            <div id='topnav'>
                                <ul class="top-menu">
                                    ...
                                    <li class='has-sub '>
                                        <a href='uviewfile.jsp'><span>Unlock File</span></a>
                                    </li>
                                    <li class='has-sub active '>
                                        <a href="unlockfile.jsp"><span>Lock Files</span></a>
                                    </li>
                                    <li class="has-sub">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6" style="width: 600px">
                            <h3 style="color: cornflowerblue;">File Details</h3>
                        </div>
                    </div>
                    <!-- /.row -->
                </div>
            </div>
            <!--<div style="background-image: url('images/ahome.jpg');height: 150px; width: 200px;">-->
            ...
            <div class="row">
                <div class="box" style="height: 400px;">
                    ...
                    <!--<div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">-->
                        <!--<center><h3>Commander Details</h3></center><br />-->
                        <table border="1" style="text-align: center;margin-left: 180px">
                            <tr>
                                ...
                                <th style="text-align: center;width: 100px;">Lock</th>
<!--                                <th style="text-align: center;width: 100px;">unlock</th>-->
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("SELECT * FROM upload WHERE name ='" + name + "' AND showfile='No'");
                                        while(rs.next())
...
<!--                                        <td></td>     
                                        <td></td>     
-->                        <td> <a href="unlockpass.jsp?"><font style="color: green">Unlock</a></font> </td>
                        <!--<td> <a hrefun="mail.jsp?"><font style="color: red">unlock</a></font> </td>--> 
                         <!--<td> <a href="mail.jsp?"><font style="color: red">Download</a></font> </td>--> 
                                        <tr />
                                        <%} 
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
        ...
        <!-- /.container -->
            ...
            <div class="container" style="">
                <div class="row" style="width: 800px"><br>
                    <div class="col-md-8">
                        <center><h3 style="color: white;margin-left: 200px"></h3></center>
<!--                        <form class="contact-form" action="loginaction.jsp" method="post" style="margin-top: 40px;margin-left: 220px">
                            <label style="color: white">User Name</label>
                            <input type="text" class="form-control" name="name" placeholder="Admin ID"/>
